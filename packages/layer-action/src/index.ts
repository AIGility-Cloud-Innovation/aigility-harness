...
export const manifest: PluginManifest = {
  ...
  layer: LayerId.Action,
  description: "行动执行层：工具执行 + 文本转语音 + 编码代理工人(codex/zcode/claude) + TiMEM 记忆检索/写入",
  version: "0.4.0",
...
export const plugin: LayerPlugin = {
  ...
  getProviders(): Provider[] {
    ...
    return [toolExecutionProvider, textToSpeechProvider, codexAgentProvider, zcodeAgentProvider, claudeAgentProvider, createTimemMemoryProvider(timemClient), createTimemMemoryWriteProvider(timemClient)];
  },
